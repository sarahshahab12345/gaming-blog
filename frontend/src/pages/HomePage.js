    ...
    <div className="page-enter">
      ...
      >
        ...
        <div className="absolute inset-0">
          ...
          <div
            className="absolute bottom-10 right-10 w-96 h-96 bg-gaming-neon/5 rounded-full blur-3xl animate-pulse-slow"
            style={{ animationDelay: "1s" }}
          />

          <div
            className="absolute top-1/2 left-1/2 w-64 h-64 bg-purple-900/20 rounded-full blur-3xl animate-pulse-slow"
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          {/* Badge */}
          <div className="hero-badge inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gaming-accent/10 border border-gaming-accent/30 text-gaming-accent-light text-xs font-heading font-bold uppercase tracking-wider mb-6">
            <span className="w-2 h-2 rounded-full bg-gaming-neon animate-pulse" />
            Level Up Your Gaming Knowledge
          </div>

          {/* Headline */}
          <h1 className="hero-title font-display text-6xl sm:text-7xl lg:text-8xl tracking-wider mb-4">
            <span className="neon-purple">PIXEL</span>
            <span className="neon-text">GATE</span>
          </h1>

          <p className="hero-description text-gaming-muted text-lg sm:text-xl max-w-2xl mx-auto mb-8 leading-relaxed">
